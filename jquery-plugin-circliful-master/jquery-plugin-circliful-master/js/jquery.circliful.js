    ...
    return this.each(function() {
      ...
      if (settings.targetPercent > 0 && settings.halfCircle !== true) {
        ...
        elements +=
          ...
          (435 / 100) * settings.targetPercent +
      ...
      if (settings.text !== null) {
        if (settings.halfCircle) {
          if (settings.textBelow) {
            elements +=
              '<text text-anchor="middle" x="' +
              (settings.textX !== null ? settings.textX : "100") +
              '" y="' +
              (settings.textY !== null ? settings.textY : "64%") +
              '" style="' +
              settings.textStyle +
              '" fill="' +
              settings.textColor +
            ...
            elements +=
              ...
              (settings.textX !== null ? settings.textX : "100") +
              '" y="' +
              (settings.textY !== null ? settings.textY : "115") +
              '" style="' +
              settings.textStyle +
              '" fill="' +
              settings.textColor +
          ...
          if (settings.textBelow) {
            elements +=
              ...
              (settings.textX !== null ? settings.textX : "100") +
              '" y="' +
              (settings.textY !== null ? settings.textY : "99%") +
              '" style="' +
              settings.textStyle +
              '" fill="' +
              settings.textColor +
        ...
        var timer = window.setInterval(
          function() {
            ...
            if (settings.replacePercentageByText === null) {
              ...
              if (
                !settings.alwaysDecimals &&
                (percent === 0 || (percent > 1 && last !== 1))
              ) {
                text = parseInt(text);
              }
            }
        ...
        if (settings.multiPercentage === 1) {
          ...
          for (index = 0; index < percentages.length; ++index) {
            ...
            circles +=
              ...
              '" cx="100" cy="100" r="' +
              radius +
              '" class="border" fill="none" stroke="' +
              color +
              '" stroke-width="' +
              settings.foregroundBorderWidth +
              '" stroke-dasharray="' +
              calculateFillMulti +
              ',20000" transform="rotate(' +
              rotate +
              ',100,100)" />';
          }
